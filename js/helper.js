...
var HTMLprojectStart = '<div class="project-entry"></div><div class="clearfix"><br></div>';
var HTMLprojectTitle = '<a href="#">%data%</a>';
var HTMLprojectDates = '<div class="date-text">%data%</div>';
var HTMLprojectDescription = '<p><br>%data%</p><br><br><div class="col-sm-12 col-xs-12 images-section"></div>';
var HTMLprojectImage = '<img src="%data%" class="project-image img-responsive" alt="Project Image">';
...
var internationalizeButton = '<button class="btn btn-danger pull-right">Internationalize</button>';
...
// TODO: Check logs for function before submitting
